...
@section('customCSS')
    <link rel="stylesheet" href="{{ asset('style/css/register-perusahaan.css') }}" type="text/css">
@endsection
...
@section('content')
    <div class="register-photo">
      <div class="form-container">
          ...
          <form method="post">
              <h2 class="text-center"><strong>Registrasi</strong> Perusahaan</h2>
              <div class="form-group"><input class="form-control" type="text" name="name" placeholder="Nama instansi anda"></div>
              ...
              <p class="already">Sudah memiliki akun? <a class="linkColor" href="#">Login</a> disini.</p>
            </form>
      </div>
    </div>
@endsection