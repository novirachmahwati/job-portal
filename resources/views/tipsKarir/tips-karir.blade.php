...
@section('title', 'Tips Karir')

@section('main-navigation', 'main-navigation')
@section('tipsKarir_active', 'active')

@section('customCSS')
    <link rel="stylesheet" href="{{ asset('style/css/tips-karir.css') }}" type="text/css">
@endsection
...
@section('content')
     ...
     <div class="page-header">
        <div class="container">
          <div class="row">         
            <div class="col-md-7">
              <h3 style="padding-left: 10px">Temukan Tips Karir di Findajob<span class="titik-logo">.</span></h3>
